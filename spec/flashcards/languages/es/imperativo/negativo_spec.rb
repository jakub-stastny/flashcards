...
describe 'Negative informal commands' do
  ...
  it 'handles reflective verbs' do
    expect(spanish._verb('hablarse').imperativo_negativo.tú).to eql(spanish._verb('hablar').imperativo_negativo.tú)
    expect(spanish._verb('comerse').imperativo_negativo.tú).to eql(spanish._verb('comer').imperativo_negativo.tú)
    expect(spanish._verb('vivirse').imperativo_negativo.tú).to eql(spanish._verb('vivir').imperativo_negativo.tú)
  end
