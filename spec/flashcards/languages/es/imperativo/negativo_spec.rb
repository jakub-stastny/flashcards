...
describe 'Negative informal commands' do
  ...
  it 'handles reflective verbs' do
    expect(spanish.verb('hablarse').imperativo_negativo.tú).to eql(spanish.verb('hablar').imperativo_negativo.tú)
    expect(spanish.verb('comerse').imperativo_negativo.tú).to eql(spanish.verb('comer').imperativo_negativo.tú)
    expect(spanish.verb('vivirse').imperativo_negativo.tú).to eql(spanish.verb('vivir').imperativo_negativo.tú)
  end
