...
describe 'Subjunctivo futuro' do
  ...
  it 'handles reflective verbs' do
    expect(spanish.load_verb('hablarse').subjuntivo_futuro.él).to eql(spanish.load_verb('hablar').subjuntivo_futuro.él)
    expect(spanish.load_verb('comerse').subjuntivo_futuro.él).to eql(spanish.load_verb('comer').subjuntivo_futuro.él)
    expect(spanish.load_verb('vivirse').subjuntivo_futuro.él).to eql(spanish.load_verb('vivir').subjuntivo_futuro.él)
  end
