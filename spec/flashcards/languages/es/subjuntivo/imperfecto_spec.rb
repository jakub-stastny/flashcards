...
describe 'Subjunctivo imperfecto' do
  ...
  it 'handles reflective verbs' do
    expect(spanish.load_verb(app, 'hablarse').subjuntivo_imperfecto.él).to eql(spanish.load_verb(app, 'hablar').subjuntivo_imperfecto.él)
    expect(spanish.load_verb(app, 'comerse').subjuntivo_imperfecto.él).to eql(spanish.load_verb(app, 'comer').subjuntivo_imperfecto.él)
    expect(spanish.load_verb(app, 'vivirse').subjuntivo_imperfecto.él).to eql(spanish.load_verb(app, 'vivir').subjuntivo_imperfecto.él)
  end
