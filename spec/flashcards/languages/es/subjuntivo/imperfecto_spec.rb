...
describe 'Subjunctivo imperfecto' do
  ...
  it 'handles reflective verbs' do
    expect(spanish.verb('hablarse').subjunctivo_imperfecto.él).to eql(spanish.verb('hablar').subjunctivo_imperfecto.él)
    expect(spanish.verb('comerse').subjunctivo_imperfecto.él).to eql(spanish.verb('comer').subjunctivo_imperfecto.él)
    expect(spanish.verb('vivirse').subjunctivo_imperfecto.él).to eql(spanish.verb('vivir').subjunctivo_imperfecto.él)
  end
