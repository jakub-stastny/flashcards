...
describe 'Futuro' do
  ...
  it 'handles reflective verbs' do
    expect(spanish.load_verb(app, 'hablarse').futuro.él).to eql(spanish.load_verb(app, 'hablar').futuro.él)
    expect(spanish.load_verb(app, 'comerse').futuro.él).to eql(spanish.load_verb(app, 'comer').futuro.él)
    expect(spanish.load_verb(app, 'vivirse').futuro.él).to eql(spanish.load_verb(app, 'vivir').futuro.él)
  end
