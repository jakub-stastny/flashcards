...
describe 'Futuro' do
  ...
  it 'handles reflective verbs' do
    expect(spanish._verb('hablarse').futuro.él).to eql(spanish._verb('hablar').futuro.él)
    expect(spanish._verb('comerse').futuro.él).to eql(spanish._verb('comer').futuro.él)
    expect(spanish._verb('vivirse').futuro.él).to eql(spanish._verb('vivir').futuro.él)
  end
