...
describe 'Condicional' do
  ...
  it 'handles reflective verbs' do
    expect(spanish.load_verb(app, 'hablarse').condicional.él).to eql(spanish.load_verb(app, 'hablar').condicional.él)
    expect(spanish.load_verb(app, 'comerse').condicional.él).to eql(spanish.load_verb(app, 'comer').condicional.él)
    expect(spanish.load_verb(app, 'vivirse').condicional.él).to eql(spanish.load_verb(app, 'vivir').condicional.él)
  end
