...
describe 'Imperfecto' do
  ...
  it 'handles reflective verbs' do
    expect(spanish.load_verb('hablarse').imperfecto.él).to eql(spanish.load_verb('hablar').imperfecto.él)
    expect(spanish.load_verb('comerse').imperfecto.él).to eql(spanish.load_verb('comer').imperfecto.él)
    expect(spanish.load_verb('vivirse').imperfecto.él).to eql(spanish.load_verb('vivir').imperfecto.él)
  end
