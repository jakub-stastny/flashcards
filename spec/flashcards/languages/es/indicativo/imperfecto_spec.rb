...
describe 'Imperfecto' do
  ...
  it 'handles reflective verbs' do
    expect(spanish._verb('hablarse', Hash.new).imperfecto.él).to eql(spanish._verb('hablar', Hash.new).imperfecto.él)
    expect(spanish._verb('comerse', Hash.new).imperfecto.él).to eql(spanish._verb('comer', Hash.new).imperfecto.él)
    expect(spanish._verb('vivirse', Hash.new).imperfecto.él).to eql(spanish._verb('vivir', Hash.new).imperfecto.él)
  end
